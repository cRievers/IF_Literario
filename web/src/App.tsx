...
function App() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!supabase) {
      setErrorMsg('Supabase não configurado. Por favor, adicione VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY no seu arquivo .env na raiz de web/')
      setLoading(false)
      return
    }
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 flex items-center justify-center p-4 overflow-hidden font-sans">
      {/* Decorative background blobs for rich visuals */}
